...
export const increaseQuantity = async (cartItemsId: number, quantity:number): Promise<string> => {
  try{
    const response = await fetch(`${BASE_URL}/cart/${cartItemsId}/increase`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
...
export const decreaseQuantity = async (cartItemsId: number): Promise<string> => {
  try{
    const response = await fetch(`${BASE_URL}/cart/${cartItemsId}/decrease`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
...
export const deleteCartItems = async (cartItemsId: number): Promise<string> => {
  try{
    const response = await fetch(`${BASE_URL}/cart/${cartItemsId}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
